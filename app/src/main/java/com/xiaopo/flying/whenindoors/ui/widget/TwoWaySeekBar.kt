...
import com.xiaopo.flying.whenindoors.kits.clamp
import com.xiaopo.flying.whenindoors.kits.dp
import com.xiaopo.flying.whenindoors.kits.modifyAlpha
...
class TwoWaySeekBar @JvmOverloads constructor(context: Context,
  ...
  init {
    attr?.let {
      ...
      minValue = typedArray.getFloat(R.styleable.TwoWaySeekBar_minValue, -10f)
      maxValue = typedArray.getFloat(R.styleable.TwoWaySeekBar_maxValue, 10f)
